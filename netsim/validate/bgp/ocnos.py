"""
OcNOS BGP validation (exec_/valid_ screen-scrape contract over the Ansible transport).
...
def exec_bgp_neighbor(ngb: list, n_id: str, af: str = 'ipv4', *,
...
def valid_bgp_neighbor(ngb: list, n_id: str, af: str = 'ipv4', *,
  ...
  established = bool(row) and _row_established(row)
...
def exec_bgp_prefix(pfx: str, af: str = 'ipv4', vrf: str = 'default',
                    **kwargs: typing.Any) -> str:
