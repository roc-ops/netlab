"""
OcNOS IS-IS validation (exec_/valid_ screen-scrape contract over the Ansible transport).
...
hostname, state and level (Type = L1/L2/L1L2).
"""
...
def exec_isis_neighbor(id: str, **kwargs: typing.Any) -> str:
...
def exec_isis_prefix(pfx: str, level: str = '2', **kwargs: typing.Any) -> str:
